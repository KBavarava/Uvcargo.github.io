      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          ...
          <div class="right-menu list-inline no-margin-bottom">    
            ...
            <a id="logout" href="..\..\Uvbrlog\index.php" class="nav-link">Logout <i class="icon-logout"></i></a></div>
          </div>
        </div>
      </nav>
    </header>
              ...
              <div class="col-lg-12">
                ...
                <div class="bar-chart block no-margin-bottom">
                 ...
                 <div class="brand-text brand-big visible text-uppercase">
                  ...
                  <center> <strong class="text-primary">Branch</strong></div></center><br>
                  <center> <strong ><?php echo $_SESSION['branch']; ?></strong></div></center>
                </div>
                </h1>
